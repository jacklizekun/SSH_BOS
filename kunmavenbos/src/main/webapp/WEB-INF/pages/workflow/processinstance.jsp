...
<script type="text/javascript">
	...
	function show(processInstanceId){
		// 弹出页面 
		window.showModalDialog("${pageContext.request.contextPath}/processinstance_showpng.action?processInstanceId="+processInstanceId);
	}
</script>	
</head>
